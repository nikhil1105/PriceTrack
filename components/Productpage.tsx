...
const Productpage = ({ data }: { data: any }) => {
    ...
    if (!data) {
        return <div className=" flex bg-[#fef7f2] items-center justify-center w-[100vw] h-[80vh]" > <img src="../assets/gif/ani.gif" className=" w-fit h-fit object-cover " /> </div>
    }
    ...
    return (
        <div className=" flex flex-col items-center justify-center  flex-wrap  py-24">
                    ...
                    <div className="flex justify-between items-start gap-5 flex-wrap pb-6">
                        ...
                        <div className="  flex items-center gap-3">
                            <div className=" flex items-center gap-2 px-3 py-2 bg-[#FFF0F0] rounded-10">
                                <Image src='/assets/icons/red-heart.svg' alt="" width={20} height={20} />
                        ...
                        <div className="  flex flex-col gap-4">
                            <div className="flex gap-3">
                                <div className="flex items-center gap-2 px-3 py-2 bg-[#FBF3EA] rounded-[27px]">
                                    ...
                                    <p className="text-sm text-[#D48D3B] font-semibold">{product?.star}</p>
                                </div>
                            ...
                            <p className="text-sm opacity-50">
                                <span className=" font-semibold">{(parseFloat(product?.star) * 100 / 5).toFixed(2)} %</span> of buyers have recommeded this.
                            </p>
                        </div>
                    </div>
                    <div className="py-6 w-full">
                        ...
                        <div>
                            <button className=" w-[50%] bg-black mx-auto flex items-center justify-center gap-3 min-w-[200px] my-4 py-4 px-4 hover:bg-opacity-70 rounded-[30px] text-white text-lg font-semibold " >
                                ...
                                />
                                <Link href={product?.link} target="_blank" className="text-base text-white" >Buy Now</Link>
                            </button>
                        </div>
                    </div>
            ...
            <div className="" >
                ...
                <div className={` ${product.detail[1].length == 0 ? 'hidden' : ''} max-w-[100vw] `}>
                    <h2 className="font-bold">
                        About this item
                    </h2>
