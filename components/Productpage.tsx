...
const Productpage = ({ data }: { data: any }) => {
    ...
    return (
        <div className="flex flex-col gap-16 flex-wrap px-6 md:px-20 py-24">
            ...
            <div className={`${product.detail[0][0].length == 0 ? 'hidden' : ''}`} >
            ...
            <div className={`${product.detail[1].length == 0 ? 'hidden' : ''}`}>
                <h2 className="font-bold">
                    About this item
                </h2>
                <div className="m-4" >
                    <div >
                        ...
                        {product.detail[1].map((row: any, rowIndex: any) => {
                            ...
                            return rowIndex !== product.detail[1].length - 1 && <li className="px-4 py-2" key={rowIndex}>{row}</li>
                        }
            ...
            <div className={`${product.detail[2][0].length == 0 ? 'hidden' : ''}`}>
                <h2 className="font-bold">
                    Details
                </h2>
                <div className="m-4">
