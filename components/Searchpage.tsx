    ...
    <div className="flex flex-col  ">
      ...
      {products?.map((e: any) => (
        ...
        >
          <div
            key={e.id}
            className=" bg-white hover:bg-slate-200 border-slate-200 my-4 w-full  py-4 border rounded-lg  flex flex-row items-center  justify-items-start "
          >
            ...
            <div className=" text-black text-[20px] font-bold m-4 ">
              ...
              <div className="flex flex-wrap">
                <div className="flex items-center  gap-2 px-3 py-2 bg-[#FBF3EA] rounded-[27px]">
                  <Image
                    ...
                    height={16}
                  />
                  <p className="text-sm max-sm:text-[12px] text-[#D48D3B] font-semibold">
                    {e.star}
                  </p>
                </div>{" "}
              ...
              <span className=" text-red-600 max-sm:text-[12px]  m-1 px-2 py-[2px]">
                {e.offer}
              </span>
            </div>
          </div>
